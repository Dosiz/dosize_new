										...
										<div class="col-12 blog-details">
											<form action="<?php echo e(route('blog.store')); ?>" enctype="multipart/form-data" method="post">
					                            ...
					                            <div class="form-group">
					                                ...
					                                <input class="form-control" type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" placeholder="הכנס כותרת ראשית (מומלץ: טקסט מעניין)">
					                                <div style="color:red;"><?php echo e($errors->first('title')); ?></div> <br>
					                            </div>
					                            <div class="form-group">
					                                <label>כותרת משנה</label>
					                                <input class="form-control" type="text" name="sub_title" id="sub_title" value="<?php echo e(old('sub_title')); ?>" placeholder="הכנס כותרת משנה">
												...
												<div class="form-group">
													...
													<select name="blog_id[]" class="select2-multiple_ form-control" multiple="multiple" id="select2MultipleEe">
														...
														<?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recomended_blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo e($recomended_blog->id); ?>" ><?php echo e($recomended_blog->title); ?></option>
					                            ...
					                            <div class="form-group">
					                                ...
					                                <textarea cols="30" rows="6" class="form-control summernote" name="description" placeholder="כתוב טקסט עם סימני פיסוק ושורות על מנת שהכתבה תראה טובה ומכובדת" id="description" value="<?php echo e(old('description')); ?>"></textarea>
					                                <div style="color:red;"><?php echo e($errors->first('description')); ?></div> <br>
					                            </div>

												<div class="form-group">
					                                <label> תגים </label>
					                                <input class="form-control" data-role="tagsinput" type="text" name="tags" value="<?php echo e(old('tags')); ?>" placeholder="Tags" style="display: block; color:#111;">
					                                <div style="color:red;"><?php echo e($errors->first('tags')); ?></div> <br>
					                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dosize_new\resources\views/brand/blog/add.blade.php ENDPATH**/ ?>