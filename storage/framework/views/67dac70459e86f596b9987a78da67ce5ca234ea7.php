			...
			<div class="row">
				<div class="col-md-4 text-center pt-4">
					...
					<p style="font-size: 18px; color: #fff;">
						<?php echo e($brand_profile->user->email); ?> <i class="fa fa-envelope"></i>
					</p>
				</div>
				<div class="col-md-4 text-center pt-4">
					<p style="font-size: 18px; color: #fff !important; ">
						<a href='tel:<?php echo e($brand_profile->whatsapp_no); ?>' style="font-size: 18px; color: #fff !important; "> <?php echo e($brand_profile->whatsapp_no ?? ''); ?> <i class="fa fa-phone"></i></a>
					</p>
				</div>
				<div class="col-md-4 text-center pt-4">
					<p style="font-size: 18px; color: #fff;">
						<?php echo e($brand_profile->brandaddresses['0']->address); ?> <i class="fa fa-map-marker"></i>
					</p>
				</div>
			</div>
		</div>
		<a href="https://api.whatsapp.com/send?phone=<?php echo e($brand_profile->whatsapp_no ?? ''); ?>&amp;text=%D7%A9%D7%9C%D7%95%D7%9D%20%D7%95%D7%91%D7%A8%D7%9B%D7%94%2C%20%D7%90%D7%A0%D7%99%20%D7%A4%D7%95%D7%A0%D7%94%20%D7%90%D7%9C%D7%99%D7%9A%20%D7%9E%D7%94%D7%90%D7%AA%D7%A8%20%D7%A9%D7%9C%D7%9A%20%D7%91%D7%93%D7%95%D7%A1%D7%99%D7%96%20%D7%A6%D7%A8%D7%9B%D7%A0%D7%95%D7%AA%2C%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%91%D7%91%D7%A7%D7%A9%D7%94..." class="float" target="_blank">			  
	...
	<!-- /Footer -->
	 ...
	 <?php /**PATH C:\wamp64\www\dosize_new\resources\views/layout/partials/brand_signup_footer.blade.php ENDPATH**/ ?>