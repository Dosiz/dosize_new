                        ...
                        <div class="heart_tag_message_list">
                            <ul>
                                <li>
                                    ...
                                    <span class="comment_count"> <?php echo e(count($blog_comments)); ?> </span>
                                    <?php else: ?>
                                ...
                                <li>
                                    <form id="">
                                        <?php echo csrf_field(); ?>
                                        <?php if(count($blog_likes) > 0): ?>
                                        <span class="like_count"> <?php echo e(count($blog_likes)); ?> </span>
                                        <?php else: ?>
                                ...
                                <li>
                                    <form id="">
                                        <?php echo csrf_field(); ?>
                                        <?php if(count($blog_bookmarks) > 0): ?>
                                        <span class="bookmark_count"> <?php echo e(count($blog_bookmarks)); ?> </span>
                                        <?php else: ?>
                                        <span class="bookmark_count"> 0 </span>
                                        <?php endif; ?>
                                        <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
                                        <?php if($blog_bookmark): ?>
...
</header><?php /**PATH C:\wamp64\www\dosize_new\resources\views/layout/partials/article_header.blade.php ENDPATH**/ ?>