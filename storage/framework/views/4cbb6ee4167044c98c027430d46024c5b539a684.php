	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="<?php echo e(url('/dashboard/dashboard')); ?>" class="logo">
					<img src="../assets_admin/img/logo.png" alt="Logo">
				</a>
				<a href="<?php echo e(url('/dashboard/dashboard')); ?>" class="logo logo-small">
		...
		<!-- /Header --><?php /**PATH C:\wamp64\www\dosize_new\resources\views/layout/partials/admin_header.blade.php ENDPATH**/ ?>