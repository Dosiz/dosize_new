                ...
                <div class="row">
                    <div class="col-6 col-xl-4 mb-3">
                        <div class="card">
                            ...
                            <img src="{{asset('assets/img/B_Card.png') }}" alt="card" class="d-xl-block d-none">
                            <div class="title d-flex justify-content-end align-items-center">
                                ...
                                <img src="{{asset('assets/img/mobile_component/flashes_2.png') }}" class="d-xl-none"
                                    alt="flash">
                                <img src="{{asset('assets/img/card_title_img.png') }}" alt="flash"
                    ...
                    <!-- <div class="col-6 col-xl-3 mb-3">
                        <div class="card">
                            ...
                            <div class="title d-flex justify-content-end align-items-center">
                                <h3>בזאר שטראוס</h3>
                                <img src="{{asset('assets/img/mobile_component/flashes_2.png') }}" alt="flash">
                            </div>
