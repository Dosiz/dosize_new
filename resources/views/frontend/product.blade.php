                                ...
                                <div class="swiper-wrapper">
                                    @if (count($categories) > 0)
                                        ...
                                        @foreach ($categories as $key => $category)
                                            <div onclick="open_category('{{ route('category_by_city', ['category_id' => $category->id, 'city_id' => $product->cities['0']->id]) }}')"
                                        ...
                                        @if ($product->images != null)
                                            <div class="swiper-slide">
                                                <img src="{{ asset('product/' . $product->image) }}" alt=""
                                                    class="img-fluid"style="width:360px; height:353px;">
                                            </div>
                                            @foreach (json_decode($product->images) as $all)
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('product/' . $all) }}" alt=""
                                                        class="img-fluid"style="width:360px; height:353px;">
                                                </div>
                                            @endforeach
                                        @else
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        @if ($product->images != null)
                                            <div class="swiper-slide swiperThumbImg">
                                                <img src="{{ asset('product/' . $product->image) }}" alt=""
                                                    class="img-fluid"style="width:131px; height:129px;">
                                            </div>
                                            @foreach (json_decode($product->images) as $all)
                                                <div class="swiper-slide swiperThumbImg">
                                                    <img src="{{ asset('product/' . $all) }}" alt=""
                        ...
                        <div class="row">
                            <div class="col-6 col-xl-12 text-left d-xl-none">
                                <div class="product_price">
                                    @if ($product->discount_price)
                                        <p>{{ $product->discount_price }} ₪ <span
                                                class="font-size-14">{{ $product->price }} ₪</span></p>
                                    @else
                                        <p>{{ $product->price }} ₪ </p>
                                    @endif
                            ...
                            <div class="col-6 col-xl-12 text-right">
                                <div class="product_category">
                                    <a href="https://{{ $product->brandprofile->short_name ?? '' }}.arikliger.com">
                                        {{-- @php
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-right">
                            <h3 class="common_title px-xl-2">מוצרים שאולי יעניינו אתכם גם <img
                                    src="{{ asset('assets/img/mobile_component/deals.png') }}" alt=""
                                    class="img-fluid"></h3>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach ($recomanded_products as $recomanded_product)
                                    <div class="deals_box box_shahdow swiper-slide">
                                        <a class="font-size-14 font-weight-700"
                                            href="{{ route('product', $recomanded_product->recomended_product->id ?? '') }}">
                                            <img src="{{ asset('product/' . $recomanded_product->recomended_product->image) }}"
            ...
            <div class="container-fluid container_desk">
                <div class="row flex-xl-row-reverse">
                    ...
                    <div class="col-lg-12 col-xl-6">
                        <div class="stand_brand_message">
                            <img src="{{ asset('brand_image/' . $product->brandprofile->brand_image) }}" alt=""
                                class="img-fluid" style="width:39px ; height: 38px;">
                            <a class="font-size-16"
                                href="https://{{ $product->brandprofile->short_name ?? '' }}.arikliger.com">לעמוד
                                המותג</a>
                            @guest
                            ...
                            @else
                                <a class="font-size-16"
                                    href="{{ url('brand/messages?id=' . $product->brandprofile->user_id . '') }}">שליחת
                                    הודעה</a>
                            @endguest
                        </div>
                    </div>
                    <div class="col-lg-12 col-xl-6">
                        <div class="sign_up_div">
                            ...
                            @guest
                                <a href="" id="class="enrollemnt_button" data-toggle="modal"
                                    data-target="#enrollmentModal2"
                                    style="color: #212529 !important; display:flex; flex-direction:row-reverse;align-items:center">
                                    @if ($chk_subscriber == null)
                                        <img src="{{ asset('assets/img/mobile_component/sign_up_icon.png') }}" alt=""
                                            class="img-fluid new_subscriber">
                                        <img src="{{ asset('assets/img/verfied.png') }}" alt=""
                                            class="img-fluid d-none subscribed">
                                    @else
                                        <img src="{{ asset('assets/img/verfied.png') }}" alt="" class="img-fluid">
                                    @endif
                                    <p class="font-size-16">הירשמו בקליק למועדון הצרכנות של <br>
                                        <span
                                            style="color: #db1580">{{ \Illuminate\Support\Str::limit($product->brandprofile->brand_name ?? '', 15) }}</span>
                                        ולא תפספסו שום דיל!
                                    </p>
                                </a>
                            @else
                                <a href="" id="subscriber">
                                    @if ($chk_subscriber == null)
                                        <img src="{{ asset('assets/img/mobile_component/sign_up_icon.png') }}" alt=""
                                            class="img-fluid new_subscriber">
                                        <img src="{{ asset('assets/img/verfied.png') }}" alt=""
                                            class="img-fluid subscribed" style="display: none !important;">
                                    @else
                                        <img src="{{ asset('assets/img/verfied.png') }}" alt="" class="img-fluid">
                                    @endif
                                    <p class="font-size-16">הירשמו בקליק למועדון הצרכנות של <br>
                                        ...
                                        <input type="hidden" id="brand_profile_id"
                                            value="{{ $product->brand_profile_id }}" />
                    ...
                    <div class="col-xl-8">
                        <div class="post_comment">
                            <div class="total_comment">
                                ...
                                @endguest
                                <p></p>
                                <p class="font-size-16">תגובות (<span
                                        class="product_comment_count">{{ count($product_comments) }}</span>) <img
                                        src="{{ asset('assets/img/mobile_component/comment.png') }}" alt=""
                                        class="img-fluid">
                                </p>
                            </div>
                            <form action="{{ route('store-product-comment') }}" method="POST"
                                class="d-flex flex-column align-items-cente">
                                @csrf
                                ...
                                <ul>
                                    <li>
                                        <span>
                                            <div class="rating">
                                                <input type="radio" id="field1_star5" name="bedside_manner_rating"
                                                    value="5" /><label class="full" for="field1_star5"></label>
                                                <input type="radio" id="field1_star4" name="bedside_manner_rating"
                                                    value="4" /><label class="full" for="field1_star4"></label>
                                                <input type="radio" id="field1_star3" name="bedside_manner_rating"
                                                    value="3" /><label class="full" for="field1_star3"></label>
                                                <input type="radio" id="field1_star2" name="bedside_manner_rating"
                                                    value="2" /><label class="full" for="field1_star2"></label>
                                                <input type="radio" id="field1_star1" name="bedside_manner_rating"
                                                    value="1" /><label class="full" for="field1_star1"></label>
                                            </div>
                                        </span>
                                    </li>
                                </ul>
                                <div class="d-flex w-100 flex-row-reverse align-items-center">
                                    <input type="hidden" name="product_id" class="product_id_like"
                                        value="{{ $product->id }}" />
                                    ...
                                    <div class="comment_hearder mr-4">
                                        ...
                                        <button type="submit" class="font-size-16 cursor-pointer"
                                            style="white-space: pre">פירסום תגובה</button>
                                ...
                                <ul class="new_comment_list">
                                    @if (count($product_comments) > 0)
                                        @foreach ($product_comments as $comment)
                                            <li>
                                                @guest
                                                    <p class="add_comment font-size-12" style="visibility: hidden">הוספת תגובה
                                                    </p>
                                                @else
                                                    @if (Auth::user()->hasRole('Brand'))
                                                        <a href="#" class="add_comment font-size-12 text-dark">הוספת
                                                            תגובה</a>
                                                    @else
                                                        <p class="add_comment font-size-12" style="visibility: hidden">הוספת
                                                            תגובה</p>
                                                    @endif
                                                @endguest
                                                <div
                                                    class="user_detail d-flex justify-content-between align-items-baseline">
                                                    <div class="mr-2">
                                                        @if ($comment->rating)
                                                            @for ($i = 1; $i <= $comment->rating; $i++)
                                                                ...
                                                                @endif
                                                                <i class="fa fa-star"
                                                                    style="color: @if ($comment->rating < 3) #FDCC0D; @else #ff9529; @endif"></i>
                                                            @endfor
                                                        @endif
                                                    </div>
                                                    <div>
                                                        <h4 class="font-size-14">
                                                            {{ $comment->name ?? $comment->user->name }} </h4>
                                            ...
                                            <div class="formDiv replyForm">
                                                <form action="{{ route('store-product-comment') }}" method="post">
                                                    ...
                                                    <input type="hidden" name="product_id"
                                                        value="{{ $product->id }}" />
                                                    <input type="hidden" value="{{ $product->brand_profile_id }}"
                                                        id="brand_profile_id" />
                                                    <input type="hidden" name="parent_id"
                                                        value="{{ $comment->id }}" />
                                                    <input type="text" name="comment" id="comment"
                                                        placeholder="התגובה שלך" class="text-right font-size-16">

                                                    <div class="comment_hearder">
                                                        <button type="submit" class="font-size-16 cursor-pointer">פירסום
                                                            תגובה</button>
                                                    ...
                                                    <span class="text-danger comment_valid"
                                                        style="position:absolute; bottom:0px;"></span>
                                                </form>
                                            </div>
                                            @php
                                                $replies = App\Models\ProductComment::where('parent_id', $comment->id)
                                                    ->orderBy('id', 'DESC')
                                                    ->get();
                                            @endphp
                                            @if (count($replies) > 0)
                                                @foreach ($replies as $reply)
                                                    <div style="width:710px; margin-left:44px;">
                                                        <li>
                                                            <a href="#" class="add_comment font-size-12 text-dark"
                                                                style="visibility: hidden">הוספת תגובה</a>
                                                            {{-- {{Auth::user()->hasRole('Brand')}} --}}
                                                            <div class="user_detail" style="margin: 10px">
                                                                <h4 class="font-size-14">
                                                                    {{ $reply->name ?? $reply->user->name }} </h4>
                ...
                @if (count($recomanded_blogs) > 0)
                    <div class="affordable_consumption spacing article_affordable_consumption"
                        style="min-height: 100px; position: relative; display:flex;">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12 text-right">
                                    <div
                                        ...
                                        <h3 class="common_title">צרכנות משתלמת <img
                                                ...
                                                class="img-fluid"></h3>
                                        <p class="d-none d-xl-block"><a href="#" class="text-dark">לכל הכתבות ></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div
                                        class="affordable_consumption_list d-flex multiple_afforable_consumption justify-content-between">
                                        @if (count($recomanded_blogs) > 0)
                                            @foreach ($recomanded_blogs as $recomanded_blog)
                                                <div class="affordable_consumption_box box_shahdow">
                                                    <a class="font-size-14 font-weight-700"
                                                        href="{{ route('article', $recomanded_blog->recomended_blog->id) }}">
                                                        <img src="{{ asset('blog/' . $recomanded_blog->recomended_blog->image) }}"
                                                            alt="" class="img-fluid" style="width:131px;">
                                                    </a>
                                                    <div class="content_div">
                                                        <a
                                                            href="https://{{ $product->brandprofile->short_name ?? '' }}.arikliger.com">
                                            ...
                                            @endforeach
                                        @endif
                                        <a href="{{ route('all-blogs', ['category_id' => $category->id, 'city_id' => $product->cities['0']->id]) }}"
                                            class="desktop_hide learn_more font-size-12 font-weight-400">לכל
                                            הכתבות ></a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul>
                            @php
                                $shareable_links = Share::page('product_link', $product->name)
                                    ->facebook()
                                    ->whatsapp()
                                    ->twitter()
                                    ->getRawLinks();
                            ...
                            <li>
                                <a target="_blank" class="productLink" href="{{ $shareable_links['facebook'] }}">
                                    <img src="{{ asset('assets/img/mobile_component/facebook_icon.png') }}"
                                        alt="" class="img-fluid">
                                </a>
                            </li>
                        </ul>
                        <div class="copy_input">
                            ...
                            <i class="fa fa-check checked d-none" aria-hidden="true"
                                style="color:green;border:1px solid green; padding:4px; margin-top:-5px;margin-left:-5px;"></i>
