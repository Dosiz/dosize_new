                    ...
                    <div class="col-lg-12">
                        <div class="swiper myCategorySlider">
                            <div class="swiper-wrapper">
                                ...
                                <div onclick="open_category('{{route('category_by_city',['category_id'=>$category->id,'city_id'=>$product->cities['0']->id])}}')" class="category_box swiper-slide">
                    ...
                    <div class="row">
                        <div class="col-6 col-xl-12 text-left d-xl-none">
                            <div class="product_price">
                                <p>{{$product->price}} ₪ @if($product->discout_price)<span class="font-size-14">{{$product->discout_price}} ₪</span>@endif</p>
                            </div>
                        </div>
            ...
            <div class="row flex-xl-row-reverse">
                ...
                <div class="col-lg-12 col-xl-6">
                    <div class="stand_brand_message">
                        ...
                        <a class="font-size-16" href="https://{{$product->brandprofile->short_name ?? ''}}.arikliger.com">לעמוד המותג</a>
                        @guest
