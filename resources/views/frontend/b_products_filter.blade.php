            ...
            <div class="d-lg-flex" >
                ...
                <div class="inputDiv d-flex flex-column mb-4 mr-2">
                    ...
                    <select class="form-control" name="sub_category" id="sub_category">
                        ...
                        <option value="{{$sub_category->id}}" @if(isset($sub_category_id)){{ Session::get($sub_category_id ?? '') == $sub_category->id ? 'selected' : '' }} @endif>{{$sub_category->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="inputDiv d-flex flex-column mb-4 mr-2">
            ...
            <div class="container-fluid">
                <div class="d-lg-flex" >
                    <div class="inputDiv d-flex flex-column mb-4">
                        <input type="number" class="form-control" placeholder="Price" value="{{Session::get($price ?? '')}}" name="price" id="price" >
                    </div>
                    <div class="inputDiv d-flex flex-column mb-4 mr-2">
                        <button type="submit" class="btn" style="background-color: #db1580 !important; color:#fff !important;">Filter</button>
                    </div>
