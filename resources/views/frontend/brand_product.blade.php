                ...
                <div class="multiple_deals swiper">
                    <div class="swiper-wrapper recommeded_product_slider">
                        ...
                        <div class="deals_box box_shahdow swiper-slide">
                            <a class="font-size-14 font-weight-700" href="{{route('brand_product',$recomanded_product->recommended_product->id ?? '')}}">
                                <img src="{{asset('product/'.$recomanded_product->recommended_product->image)}}" alt="" class="img-flui"style="width:135px; height:107px;">
                            </a>
                            <div class="content_div">
                                <a href="https://{{$recomanded_product->recommended_product->brandprofile->short_name ?? ''}}.arikliger.com/brand">
                                <span class="deal_category font-size-12 font-weight-400">
                                    {{\Illuminate\Support\Str::limit($recomanded_product->recommended_product->brandprofile->brand_name?? '',15)}}    
                                </span></span>
                                </a>
                                <a class="font-size-14 font-weight-700" href="{{route('brand_product',$recomanded_product->recommended_product->id ?? '')}}" style="color:#212529 !important;>
                                <h4 class="title font-size-14 font-weight-700">{{$recomanded_product->recommended_product->name}}</h4></h4>
                                <div class="rating_price_div">
                                    <p class="font-size-14 font-weight-600">{{$recomanded_product->recommended_product->price}} ₪ <span
            ...
            {{-- <div class="row flex-xl-row-reverse">
                ...
                <div class="col-lg-12 col-xl-6">
                    <div class="stand_brand_message">
                        ...
                        <a class="font-size-16" href="https://{{$product->brandprofile->short_name ?? ''}}.arikliger.com/brand">לעמוד המותג</a>
                        @guest
                            ...
                            <div class="affordable_consumption_list d-flex multiple_afforable_consumption justify-content-between">
                                ...
                                <div class="affordable_consumption_box box_shahdow">
                                    <a class="font-size-14 font-weight-700" href="{{route('brand_article',$recomanded_blog->recomended_blog->id ?? '')}}">
                                        <img src="{{asset('blog/'.$recomanded_blog->recomended_blog->image)}}" alt="" class="img-fluid" style="width:131px;">
                                    </a>
                                    <div class="content_div">
                                        <a href="https://{{$product->brandprofile->short_name ?? ''}}.arikliger.com/brand">
                                        ...
                                        <a class="font-size-14 font-weight-700" href="{{route('brand_article',$recomanded_product->recomended_blog->id ?? '')}}" style="color: #212529 !important">
                                            ...
                                            <p class="discription font-size-10 font-weight-400" style="font-weight: 400px !important;">
                                                ...
                                                {{ \Illuminate\Support\Str::limit(strip_tags($recomanded_blog->recomended_blog->sub_title) ?? '',60,'...') }}
                                            </p>
                                        </a>
