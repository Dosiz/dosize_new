                    ...
                    <div class="col-lg-12 text-right">
                        <div
                            ...
                            <h3 class="common_title">צרכנות משתלמת <img
                                    ...
                                    class="img-fluid"></h3>
                            <p class="d-none d-xl-block"><a target="_blank" href="https://{{$blog->brandprofile->short_name}}.arikliger.com/articles/{{$blog->brandprofile->id}}" class="text-dark">לכל הכתבות ></a></p>
                        </div>
                    </div>
                </div>
                <div class="row">
