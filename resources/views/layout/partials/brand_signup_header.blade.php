	...
	<div class="main-wrapper">
		...
		<nav class="navbar navbar-expand-lg navbar-light" style="direction: rtl !important;">
			...
			@else
				<a href="https://beitar-illit.arikliger.com" class="logo logo-small">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					...
					@guest
                            <li class="nav-item">
                                <a href="https://beitar-illit.arikliger.com"><img style="height: 30px;" src="https://dosizlocal.com/uploads/city/logo_transparent1.png"></a>
                            </li>
{{--                             
                        @else
                            <li class="nav-item">
