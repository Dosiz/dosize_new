...
<main>
    <div class="main-wrapper">
        ...
        @if (count($p_city->products->groupBy('category_id')) > 0 )
            ...
            @foreach ($p_city->products->groupBy('category_id')->limit(4) as $key=>$product_categories)
                                ...
                                <div class="affordable_consumption">
                                    <div class="container-fluid">
                                        ...
                                        <div class="article_div">
                                            @foreach ($p_city->blogs->groupBy('category_id')->limit(4) as $blog_key=>$article_categories)
                                                @if($blog_key == $key)
